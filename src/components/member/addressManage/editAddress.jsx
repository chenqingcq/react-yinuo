                            ...
                            <div className='tags-btn'>
                                {this.state.tags.map((item, index, arr) => {
                                    if (index === 3) {
                                        ...
                                        return (
                                            <div className={(item == this.state.alias || index === this.state.tagCurrentIndex) ? 'tag-active' : 'tag-detail'} onClick={this.selectTag.bind(this, index, item)} key={index}>{item}</div>
                                        )
                                    }
                                })}
                            </div>
